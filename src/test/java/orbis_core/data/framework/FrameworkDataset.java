...
public class FrameworkDataset
{
	...
	public static FrameworkData framework1()
	{
		...
		final FrameworkNode node1 = frameworkData.addNode(BlueprintDataset.schedule1(), null).getValue();
		final FrameworkNode node2 = frameworkData.addNode(BlueprintDataset.schedule1(), null).getValue();
		final FrameworkNode node3 = frameworkData.addNode(BlueprintDataset.schedule1(), null).getValue();
		final FrameworkNode node4 = frameworkData.addNode(BlueprintDataset.schedule1(), null).getValue();
		final FrameworkNode node5 = frameworkData.addNode(BlueprintDataset.schedule1(), null).getValue();
		final FrameworkNode node6 = frameworkData.addNode(BlueprintDataset.schedule1(), null).getValue();
		final FrameworkNode node7 = frameworkData.addNode(BlueprintDataset.schedule1(), null).getValue();
		final FrameworkNode node8 = frameworkData.addNode(BlueprintDataset.schedule1(), null).getValue();
		final FrameworkNode node9 = frameworkData.addNode(BlueprintDataset.schedule1(), null).getValue();
