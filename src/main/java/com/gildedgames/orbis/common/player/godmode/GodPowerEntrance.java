...
public class GodPowerEntrance implements IGodPower
{

	private final ShapeSelectorEntrance shapeSelector;

	private GodPowerEntranceClient clientHandler;

	public GodPowerEntrance(final World world)
	{
		if (world.isRemote)
		{
			this.clientHandler = new GodPowerEntranceClient();
		}

		this.shapeSelector = new ShapeSelectorEntrance(this);
	}
