...
public class InventoryBasicExpandable implements IInventory
{
	...
	public InventoryBasicExpandable(String title, boolean customName, int slotCount)
	{
	...
	public InventoryBasicExpandable(ITextComponent title, int slotCount)
	{
	...
	public void setSlotsCount(int slotsCount)
	{
		...
		NonNullList<ItemStack> newContents = NonNullList.withSize(slotsCount, ItemStack.EMPTY);
